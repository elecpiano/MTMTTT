...
namespace MeiTuTieTie.Animations
{
    public class RotateAnimation : AnimationBase
    {
        ...
        public static RotateAnimation RotateTo(FrameworkElement cell, double to, double duration, Action<FrameworkElement> completed = null)
        {
        ...
        public static RotateAnimation RotateBy(FrameworkElement cell, double by, double duration, Action<FrameworkElement> completed = null)
        {
            RotateAnimation animation = null;
            if (AnimationPool.Count == 0)
            {
        ...
        public void InstanceRotateTo(FrameworkElement cell, double to, double duration, Action<FrameworkElement> completed = null)
        {
            this.Animate(cell, to, duration, completed);
        }

        private void Animate(FrameworkElement cell, double to, double duration, Action<FrameworkElement> completed = null)
        {
